...
const routes = [
  ...
  },
  {
    ...
    component: Home,
    children: [
      { path: 'module/list', component: moduleList, name: 'moduleList', meta: { hideLeft: false, module: 'Module', menu: 'module' }},
      { path: 'module/add', component: moduleAdd, name: 'moduleAdd', meta: { hideLeft: false, module: 'Module', menu: 'module' }},
      { path: 'module/edit/:id', component: moduleEdit, name: 'moduleEdit', meta: { hideLeft: false, module: 'Module', menu: 'module' }},
      { path: 'module/field/:id', component: fieldList, name: 'fieldList', meta: { hideLeft: false, module: 'Module', menu: 'module' }}
    ]
  }
]
