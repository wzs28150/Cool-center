<template>
	<div>
		<el-button v-show="enableShow" :loading="enableLoading" size="mini" @click="changeAttrInBtnGroup(1)">启用</el-button>
		<el-button v-show="enableShow" :loading="disableLoading" size="mini" @click="changeAttrInBtnGroup(0)">禁用</el-button>
...
<script>
  ...
  export default {
    ...
    computed: {
      enableShow() {
        // console.log(_g.getHasRule(this.type + '-enables'))
