...
return [
  ...
  // 【菜单】单独启用/禁用
  'admin/menus/change' => ['admin/menus/change', ['method' => 'POST']],
	// 【组织架构】批量删除
  ...
  // 【字段修改】字段修改 必填 系统 排序
  'admin/field/change' => ['admin/field/change', ['method' => 'POST']],
  // 【会员】批量删除
	'admin/member/deletes' => ['admin/member/deletes', ['method' => 'POST']],
  // 【数据库】数据库列表
  'admin/database/database' => ['admin/database/database', ['method' => 'GET']],
  // 【数据库】数据库优化
  'admin/database/optimize' => ['admin/database/optimize', ['method' => 'POST']],
  // 【数据库】数据库备份
  'admin/database/backup' => ['admin/database/backup', ['method' => 'POST']],
  // 【数据库】数据库备份列表
  'admin/database/restore' => ['admin/database/restore', ['method' => 'GET']],
  // 【数据库】数据库备份列表
  'admin/database/import' => ['admin/database/import', ['method' => 'POST']],

  'admin/base/refresh' => ['admin/base/refresh', ['method' => 'POST']],
